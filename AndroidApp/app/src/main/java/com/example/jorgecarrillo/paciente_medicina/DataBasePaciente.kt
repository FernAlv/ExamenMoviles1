...
class DataBasePaciente {
    ...
    companion object {
        ...
        fun insertarPaciente(paciente: Paciente) {
            "http://192.168.100.62:1337/Paciente".httpPost(listOf("nombre" to paciente.nombre, "apellido" to paciente.apellido, "fechaNacimiento" to paciente.fechaNacimiento, "numeroHijos" to paciente.numeroHijos, "afiliado" to paciente.ecuatoriano))
        ...
        fun updatePaciente(paciente: Paciente) {
            "http://192.168.100.62:1337/Paciente/${paciente.id}".httpPut(listOf("nombre" to paciente.nombre, "apellido" to paciente.apellido, "fechaNacimiento" to paciente.fechaNacimiento, "numeroHijos" to paciente.numeroHijos, "afiliado" to paciente.ecuatoriano))
                    .responseString { request, _, result ->
                        Log.d("http-ejemplo", request.toString())
                    }
        }
        ...
        fun deleteAutor(id: Int) {
            "http://192.168.100.62:1337/Paciente/$id".httpDelete()
        ...
        fun getList(): ArrayList<Paciente> {
            ...
            val (request, response, result) = "http://192.168.100.62:1337/Paciente".httpGet().responseString()
